...
The API also applies baseline hardening in-process: Helmet security headers, IP-based rate limiting, bounded request body parsing, and OpenAPI-backed request validation for incoming JSON payloads.
